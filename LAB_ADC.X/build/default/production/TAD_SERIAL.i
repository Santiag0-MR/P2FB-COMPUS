...
static unsigned char readArr[100];
static unsigned char indice = 0;
static unsigned char enviarCR = 0;
static unsigned char permisosEscritura = 0;
...
void SERIAL_Init(void){
    ...
    SPBRG = (unsigned char)((10000000UL / (16UL * 9600UL)) - 1UL);
    SPBRGH = 0;
