...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c TAD_ADC.c TAD_DISPLAY.c TAD_SERIAL.c TAD_TIMER.c TAD_LDR.c TAD_HEARTBEAT.c TAD_EEPROM.c TAD_SERIAL_TIME.c TAD_CMD.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/TAD_ADC.p1 ${OBJECTDIR}/TAD_DISPLAY.p1 ${OBJECTDIR}/TAD_SERIAL.p1 ${OBJECTDIR}/TAD_TIMER.p1 ${OBJECTDIR}/TAD_LDR.p1 ${OBJECTDIR}/TAD_HEARTBEAT.p1 ${OBJECTDIR}/TAD_EEPROM.p1 ${OBJECTDIR}/TAD_SERIAL_TIME.p1 ${OBJECTDIR}/TAD_CMD.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/TAD_ADC.p1.d ${OBJECTDIR}/TAD_DISPLAY.p1.d ${OBJECTDIR}/TAD_SERIAL.p1.d ${OBJECTDIR}/TAD_TIMER.p1.d ${OBJECTDIR}/TAD_LDR.p1.d ${OBJECTDIR}/TAD_HEARTBEAT.p1.d ${OBJECTDIR}/TAD_EEPROM.p1.d ${OBJECTDIR}/TAD_SERIAL_TIME.p1.d ${OBJECTDIR}/TAD_CMD.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/TAD_ADC.p1 ${OBJECTDIR}/TAD_DISPLAY.p1 ${OBJECTDIR}/TAD_SERIAL.p1 ${OBJECTDIR}/TAD_TIMER.p1 ${OBJECTDIR}/TAD_LDR.p1 ${OBJECTDIR}/TAD_HEARTBEAT.p1 ${OBJECTDIR}/TAD_EEPROM.p1 ${OBJECTDIR}/TAD_SERIAL_TIME.p1 ${OBJECTDIR}/TAD_CMD.p1

# Source Files
SOURCEFILES=main.c TAD_ADC.c TAD_DISPLAY.c TAD_SERIAL.c TAD_TIMER.c TAD_LDR.c TAD_HEARTBEAT.c TAD_EEPROM.c TAD_SERIAL_TIME.c TAD_CMD.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/TAD_CMD.p1: TAD_CMD.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TAD_CMD.p1.d 
	@${RM} ${OBJECTDIR}/TAD_CMD.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -memi=wordwrite -O3 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"C:/Program Files/Microchip/xc8/v3.00/pic/include/proc" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/TAD_CMD.p1 TAD_CMD.c 
	@-${MV} ${OBJECTDIR}/TAD_CMD.d ${OBJECTDIR}/TAD_CMD.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/TAD_CMD.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -memi=wordwrite -O3 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"C:/Program Files/Microchip/xc8/v3.00/pic/include/proc" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -mrom=default,-1dc0-1fff -mram=default,-1f4-1ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -memi=wordwrite -O3 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"C:/Program Files/Microchip/xc8/v3.00/pic/include/proc" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/LAB_ADC.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
